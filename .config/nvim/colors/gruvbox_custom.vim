...
let g:colors_name='gruvbox_custom'
...
let s:gb.dark0       = ['#282929', 235]
let s:gb.dark0_soft  = ['#303030', 236]
let s:gb.dark1       = ['#3a3938', 237]
let s:gb.dark2       = ['#4d4a49', 239]
let s:gb.dark3       = ['#615c59', 241]
let s:gb.dark4       = ['#756e6b', 243]
let s:gb.dark4_256   = ['#756e6b', 243]

let s:gb.gray_245    = ['#8b827b', 245]
let s:gb.gray_244    = ['#8b827b', 244]

let s:gb.light0_hard = ['#f7f5d9', 230]
let s:gb.light0      = ['#f9f3c9', 229]
let s:gb.light0_soft = ['#f0e7be', 228]
let s:gb.light1      = ['#e9dcb4', 223]
let s:gb.light2      = ['#d2c5a4', 250]
let s:gb.light3      = ['#b8ae98', 248]
let s:gb.light4      = ['#a2998a', 246]
let s:gb.light4_256  = ['#a2998a', 246]

let s:gb.bright_red     = ['#fb4334', 167]
let s:gb.bright_green   = ['#90b32e', 142]
let s:gb.bright_yellow  = ['#fbb62e', 214]
let s:gb.bright_blue    = ['#77acb7', 109]
let s:gb.bright_purple  = ['#d287a1', 175]
let s:gb.bright_aqua    = ['#7bc18e', 108]
let s:gb.bright_orange  = ['#fa7f1d', 208]

let s:gb.neutral_red    = ['#c82022', 124]
let s:gb.neutral_green  = ['#7b931f', 106]
let s:gb.neutral_yellow = ['#d19127', 172]
let s:gb.neutral_blue   = ['#3781a1',  66]  
let s:gb.neutral_purple = ['#af6493', 132]
let s:gb.neutral_aqua   = ['#5baa8e',  72] 
let s:gb.neutral_orange = ['#d15c13', 166]

let s:gb.faded_red      = ['#9a030d',  88] 
let s:gb.faded_green    = ['#687710', 100]
let s:gb.faded_yellow   = ['#b16e18', 136]
let s:gb.faded_blue     = ['#155c82',  24] 
let s:gb.faded_purple   = ['#8e407c',  96] 
let s:gb.faded_aqua     = ['#358879',  66] 
let s:gb.faded_orange   = ['#ad3805', 130]
